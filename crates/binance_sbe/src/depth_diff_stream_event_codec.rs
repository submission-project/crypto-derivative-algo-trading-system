...
pub mod encoder {
    ...
    pub struct DepthDiffStreamEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for DepthDiffStreamEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for DepthDiffStreamEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> DepthDiffStreamEventEncoder<'a> {
        ...
        /// primitive field 'firstBookUpdateId'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn first_book_update_id(&mut self, value: i64) {
        ...
        /// - version: 0
        #[inline]
        pub fn last_book_update_id(&mut self, value: i64) {
...
pub mod decoder {
    ...
    pub struct DepthDiffStreamEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for DepthDiffStreamEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for DepthDiffStreamEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for DepthDiffStreamEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> DepthDiffStreamEventDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn first_book_update_id(&self) -> i64 {
        ...
        pub fn price_exponent(&self) -> i8 {
            self.get_buf().get_i8_at(self.offset + 24)
        }

        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn qty_exponent(&self) -> i8 {
            self.get_buf().get_i8_at(self.offset + 25)
        }
    ...
    impl<'a, P> BidsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='bids', referencedName='null', description='null', packageName='null', id=100, version=0, deprecated=0, encodedLength=16, offset=26, componentTokenCount=12, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
