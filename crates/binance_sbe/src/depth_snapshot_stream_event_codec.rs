...
pub use decoder::DepthSnapshotStreamEventDecoder;
pub use encoder::DepthSnapshotStreamEventEncoder;

pub const SBE_BLOCK_LENGTH: u16 = 18;
pub const SBE_TEMPLATE_ID: u16 = 10002;
...
pub mod encoder {
    ...
    pub struct DepthSnapshotStreamEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for DepthSnapshotStreamEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for DepthSnapshotStreamEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> DepthSnapshotStreamEventEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn book_update_id(&mut self, value: i64) {
...
pub mod decoder {
    ...
    pub struct DepthSnapshotStreamEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for DepthSnapshotStreamEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for DepthSnapshotStreamEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for DepthSnapshotStreamEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> DepthSnapshotStreamEventDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn book_update_id(&self) -> i64 {
    ...
    impl<'a, P> BidsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='bids', referencedName='null', description='null', packageName='null', id=100, version=0, deprecated=0, encodedLength=16, offset=18, componentTokenCount=12, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
